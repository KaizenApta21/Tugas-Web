      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="project-card">
            ...
            <p class="project-desc">
              "Menciptakan ruang diskusi yang memadukan profesionalisme dengan kenyamanan.
              Desain kami fokus pada tata cahaya optimal dan suasana yang
              tenang untuk mendukung produktivitas serta kolaborasi ide-ide besar Anda."
            </p>
        ...
        <div class="col-md-4">
          <div class="project-card">
            ...
            <p class="project-desc">
              "Menghadirkan dapur impian yang ergonomis dan estetis.
              Kami merancang setiap sudut penyimpanan secara cerdas agar aktivitas memasak menjadi lebih
              praktis, efisien, dan tetap indah dipandang di tengah hunian Anda."
            </p>
            <a href="#" class="learn-btn">Learn more »</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="project-card">
            ...
            <p class="project-desc">
              "Mengoptimalkan area pendukung agar tetap rapi dan fungsional.
              Kami menata ruang servis secara detail untuk memaksimalkan utilitas tanpa mengorbankan nilai estetika,
              menciptakan keteraturan di setiap sudut bangunan."
            </p>
            <a href="#" class="learn-btn">Learn more »</a>
          </div>
        </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      const observerOptions = {
        threshold: 0.2 // Animasi jalan saat 20% elemen sudah terlihat di layar
      };

      const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            // Tambahkan class 'appear' saat elemen terlihat
            entry.target.classList.add('appear');
            // Berhenti memantau jika sudah muncul (agar animasi tidak berulang)
            observer.unobserve(entry.target);
          }
        });
      }, observerOptions);

      // Ambil semua kartu proyek untuk dipantau
